...
export const OSRS_CATEGORIES: OsrsCategory[] = [
  ...
  { slug: "alchemical-hydra",          name: "Alchemical Hydra",          parent: "bosses", sortOrder: 1,  iconItemId: 22966,  wikiImageSlug: "Alchemical_Hydra",          description: "The Alchemical Hydra is a boss found in the Karuulm Slayer Dungeon. It requires 95 Slayer to kill and drops powerful gear upgrades." },
  { slug: "barrows",                   name: "Barrows",                   parent: "bosses", sortOrder: 2,  iconItemId: 4716,   wikiImageSlug: "Barrows",                   description: "Barrows is a miniboss activity where players fight six brothers buried in crypts. Each brother drops pieces of their iconic equipment sets." },
  ...
  { slug: "dagannoth-kings",           name: "Dagannoth Kings",           parent: "bosses", sortOrder: 10, iconItemId: 6738,   wikiImageSlug: "Dagannoth_Kings",           description: "The Dagannoth Kings are three powerful bosses found in Waterbirth Island Dungeon. They drop the iconic dagannoth rings and the berserker ring." },
  ...
  { slug: "grotesque-guardians",       name: "Grotesque Guardians",       parent: "bosses", sortOrder: 15, iconItemId: 22245,  wikiImageSlug: "Grotesque_Guardians",       description: "Dusk and Dawn are the Grotesque Guardians atop the Slayer Tower. They require 75 Slayer and drop the black tourmaline core and granite ring." },
  ...
  { slug: "phantom-muspah",            name: "Phantom Muspah",            parent: "bosses", sortOrder: 26, iconItemId: 27371,  wikiImageSlug: "Phantom_Muspah",            description: "The Phantom Muspah is the boss of the Secrets of the North quest. It drops the saturated heart and various useful combat items." },
  ...
  { slug: "vorkath",                   name: "Vorkath",                   parent: "bosses", sortOrder: 38, iconItemId: 22115,  wikiImageSlug: "Vorkath",                   description: "Vorkath is a boss from the Dragon Slayer II quest. He reliably drops dragonbone necklaces, skeletal visages, and Vorkath's head." },
  ...
  { slug: "wintertodt",               name: "Wintertodt",                parent: "bosses", sortOrder: 40, iconItemId: 20733,  wikiImageSlug: "Wintertodt",               description: "Wintertodt is a Firemaking boss in the Land of Snow. It rewards the pyromancer outfit, warm gloves, and bruma torch through supply crates." },
  ...
  { slug: "zulrah",                    name: "Zulrah",                    parent: "bosses", sortOrder: 42, iconItemId: 12921,  wikiImageSlug: "Zulrah",                    description: "Zulrah is the snake boss of the Temple Trekking island. She drops tanzanite fang, magic fang, and serpentine visage at 1/512 each." },
